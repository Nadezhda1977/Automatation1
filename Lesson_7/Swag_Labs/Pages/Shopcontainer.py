...
class ShopContainer:
    ...
    def info(self):
        ...
        self.browser.find_element(*self.first_name).send_keys("Надежда")
        self.last_name = (By.ID, "last-name")
        self.browser.find_element(*self.last_name).send_keys("Морева")
        self.postcode = (By.ID, "postal-code")
        self.browser.find_element(*self.postcode).send_keys("357100")
